  ...
  return (
    <div class="py-12 px-4 md:px-6 2xl:px-0 2xl:container 2xl:mx-auto flex justify-center items-center">
      <div class="flex flex-col justify-start items-start w-full space-y-8">
        <div class="flex flex-col justify-center w-full gap-5 items-center">
          <p class="text-3xl lg:text-4xl text-center font-semibold leading-7 lg:leading-9 text-gray-800 dark:text-white ">
          Customer  Reviews
          </p>
          ...
          return (
            <>
              <div class="w-full flex justify-start items-start flex-col bg-gray-50 dark:bg-gray-800 p-8">
                ...
                <div class="w-full flex justify-start items-start flex-col bg-gray-50 dark:bg-gray-800 md:px-8">
                  <div class="flex flex-col md:flex-row justify-between w-full">
                    <div class="flex flex-row justify-between items-start"></div>
                    <div class="cursor-pointer mt-2 md:mt-0">{Rating}</div>
                  </div>
