...
export default function PCBuilderComponent({ pcBuilder }) {
  ...
  return (
    <div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
      ...
      <div className="mt-5 px-5 pb-5">
        ...
        <button onClick={() => addToPcBuild(pcBuilder)} className="flex w-full justify-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
          Add To Build
        </button>
      </div>
    </div>
